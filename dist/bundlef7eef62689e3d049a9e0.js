...
function _translate() {
  _translate = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(word) {
    var response, data;
...
var translateBtn = document.getElementById('wordBtn');
translateBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var getWord, data, wordDefinition, wordMeanings, newElement, meaningLength, i, newElement1;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        getWord = document.getElementById('word').value; // Use 'value' to get the input
        _context.next = 3;
        return (0,_translate__WEBPACK_IMPORTED_MODULE_1__["default"])("hello");
      case 3:
        data = _context.sent;
        if (data) {
          console.log("Function return ".concat(JSON.stringify(data)));
        }
        wordDefinition = document.getElementById("word-definition");
        wordMeanings = document.getElementById("word-meanings");
        newElement = document.createElement('div');
        newElement.innerHTML = "\n    <div>Word: ".concat(data[0].word, "</div>\n    <audio src = \"").concat(data[0].phonetics[0].audio, "\" controls>\n    <div>Origin: ").concat(data[0].origin, "</div>\n    ");
        wordDefinition.appendChild(newElement);
        meaningLength = data[0].meanings.length;
        for (i = 0; i < meaningLength; i++) {
          newElement1 = document.createElement('p');
          newElement.innerHTML = "\n        <div>".concat(data[0].meanings[i].partOfSpeech, "</div>\n        <div>").concat(data[0].meanings[i].definitions[0].definition, "</div>\n        <div>").concat(data[0].meanings[i].definitions[0].example, "</div>\n        ");
...
/******/ })()
;
//# sourceMappingURL=bundlef7eef62689e3d049a9e0.js.map